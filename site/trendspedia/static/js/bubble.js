...
//        	});
        ...
        //	$.post("api/wiki/tagtag?page="+current_page+"&tags="+querytags,plot.updateData);
        	...
        	d3.json("http://127.0.0.1:8080/bubbles/api/wiki/pagetags?titles="+querytags,plot.updateData);
...
//				;		
			...
			.on("mouseover",function(f){
				...
				if(!focusOn||focusOn.name!=f.name){
					...
					d3.json("http://127.0.0.1:8080/bubbles/api/wiki/pagelinks?title="+focusOn.name+"&center="+querytags, function(root){
