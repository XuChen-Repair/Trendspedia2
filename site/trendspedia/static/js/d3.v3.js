d3 = function() {
  ...
  d3.behavior.zoom = function() {
    ...
    function zoom() {
      this.on(mousedown, mousedowned).on(d3_behavior_zoomWheel + ".zoom", mousewheeled).on(mousemove, mousewheelreset).on(touchstart, touchstarted);//.on("dblclick.zoom", dblclicked)
    }
